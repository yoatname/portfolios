  ...
  <header id="header">
    <div class="d-flex flex-column">
      ...
      <div class="profile">
        ...
        <h1 class="text-light"><a href="index.php">Ansh Varshney</a></h1>
        <div class="social-links mt-3 text-center">
          <a href="#" class="twitter"><i class="bx bxl-twitter"></i></a>
          <a href="#" class="facebook"><i class="bx bxl-facebook"></i></a>
          <a href="#" class="instagram"><i class="bx bxl-instagram"></i></a>
          <a href="https://discord.com/channels/__ryder__#5395" class="google-plus"><i class="bx bxl-skype"></i></a>
          <a href="https://www.linkedin.com/in/ansh-varshney-84b5821b6/" class="linkedin"><i class="bx bxl-linkedin"></i></a>
        </div>
      </div>
    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <h2>Python GUI (Desktop Application)</h2>
          <ol>
        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
               ...
               <div class="swiper-slide">
                  <img src="assets/img/images/gui2.png" alt="">
                </div>

                <div class="swiper-slide">
                  <img src="assets/img/images/gui1.png" alt="">
                </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              ...
              <ul>
                <li><strong>Category</strong>: Python OOPS </li>
                <li><strong>Project Category</strong>: School Project </li>
                <li><strong>Project date</strong>: 01 March, 2020</li>
                <li><strong>Project Code</strong>: Github <a href="#">github.com/anshvarshney20/</a></li>
              </ul>
            </div>
            <div class="portfolio-description">
              <h2>About The GUI Projects</h2>
              <p>
